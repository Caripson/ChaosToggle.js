...
export const BUILTIN_THEMES: Record<string, Partial<ThemeProfile>> = {
  ...
  halloween: {
    ...
    effects: { shake: true, glitchOverlay: true, noise: true, flashOverlay: true, confetti: true, popups: true },
  ...
  christmas: {
    ...
    effects: { shake: false, flashOverlay: false, fakeErrorState: false, glitchOverlay: false, confetti: true, popups: true },
  ...
  thanksgiving: {
    ...
    effects: { shake: false, glitchOverlay: false, flashOverlay: false, noise: false, confetti: true, popups: true },
  ...
  'valentines-day': {
    ...
    effects: { shake: false, glitchOverlay: false, flashOverlay: false, fakeErrorState: false, confetti: true, popups: true },
  ...
  birthday: {
    ...
    effects: { confetti: true, popups: true, shake: false, flashOverlay: true },
  ...
  office: {
    ...
    effects: { bsod: true, fakeUpdate: true, clippy: true, delayedClicks: true, shake: false, confetti: true, popups: true },
  ...
  hacker: {
    ...
    effects: { matrixRain: true, fakeTerminal: true, glitchOverlay: true, textScramble: true, noise: true, confetti: true, popups: true },
  ...
  retro: {
    ...
    effects: { vhsDistortion: true, crtShutdown: true, noise: true, glitchOverlay: true, confetti: true, popups: true },
  ...
  apocalypse: {
    ...
    effects: { screenCrack: true, gravity: true, elementScatter: true, shake: true, fakeErrorState: true, flashOverlay: true, confetti: true, popups: true },
  ...
  drunk: {
    ...
    effects: { drunkMode: true, cursorDrift: true, invertedScroll: true, zoomFlicker: true, confetti: true, popups: true },
  ...
  jumpscare: {
    ...
    effects: { screenCrack: true, flashOverlay: true, shake: true, fakeErrorState: true, confetti: true, popups: true },
    animation: { style: 'sharp', intensityMultiplier: 1, shakeStyle: 'rumble' },
